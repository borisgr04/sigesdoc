...
public class DocExterno extends Documento {
    ...
    private String ideRemitente;

    public String getIdeRemitente() {
        return ideRemitente;
    }

    public void setIdeRemitente(String ideRemitente) {
    ...
    public Persona getOrigen() {
        ...
        for (Persona per : Sistema.instancia().getLstPer()) {
            if (per.getNroIde().equals(this.ideRemitente)) {
                Origen = (PerExterna) per;
            }
        }
        return Origen;
    }
